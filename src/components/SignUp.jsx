    ...
    <div style={{ maxWidth: "400px", margin: "auto", padding: "20px" }}>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div style={{ marginBottom: "15px" }}>
          ...
          <input
            ...
            {...register("password", {
              ...
              pattern: {
                value: /^(?=.*[a-z])(?=.*[A-Z])(?=.*[!@#$%^&*])/,
                message: "Must include 1 Uppercase, 1 Lowercase, and 1 Special Character"
              }
            })}
            style={{ display: "block", width: "100%" }}
          />
        ...
        <div style={{ marginBottom: "15px" }}>
          ...
          {errors.gender && <span style={{ color: "red", fontSize: "12px", display: "block" }}>{errors.gender.message}</span>}
        </div>
        ...
        <div style={{ marginBottom: "15px" }}>
          ...
          />
          {errors.profilePic && <span style={{ color: "red", fontSize: "12px" }}>{errors.profilePic.message}</span>}
        </div>
        ...
        <div style={{ marginBottom: "15px" }}>
          ...
          {errors.terms && <span style={{ color: "red", fontSize: "12px", display: "block" }}>{errors.terms.message}</span>}
        </div>
